...
public class Resultlevel4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultlevel4);
        ...
        databaseReference = firebaseDatabase.getReference("level_4_result");
    ...
    private void initializePDFView() {
        ...
        final ValueEventListener valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Resultlevel4.this, "Fail to get PDF url.", Toast.LENGTH_SHORT).show();
            }
        });
    }
