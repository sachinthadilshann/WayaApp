...
public class Resultlevel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultlevel2);
        ...
        databaseReference = firebaseDatabase.getReference("level_2_result");
    ...
    private void initializePDFView() {
        ...
        final ValueEventListener valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Resultlevel2.this, "Fail to get PDF url.", Toast.LENGTH_SHORT).show();
            }
        });
    }
