...
public class Resultlevel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultlevel3);
        ...
        databaseReference = firebaseDatabase.getReference("level_3_result");
    ...
    private void initializePDFView() {
        ...
        final ValueEventListener valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Resultlevel3.this, "Fail to get PDF url.", Toast.LENGTH_SHORT).show();
            }
        });
    }
