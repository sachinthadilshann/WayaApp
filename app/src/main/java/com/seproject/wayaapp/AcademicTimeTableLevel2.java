...
public class AcademicTimeTableLevel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_academic_time_table_level2);
            ...
            databaseReference = firebaseDatabase.getReference("Level 2 Academic Time Table");
            initializePDFView();
        ...
        private void initializePDFView() {
            ...
            final ValueEventListener valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(AcademicTimeTableLevel2.this, "Fail to get PDF url.", Toast.LENGTH_SHORT).show();
                }
            });
        }
